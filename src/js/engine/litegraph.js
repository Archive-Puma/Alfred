	...
	*/
    ...
    LGraphCanvas.onShowMenuNodeProperties = function(
        ...
        for (var i in node.properties) {
            ...
            entries.push({
                content:
                    "<span class='property_name' style='color: #aaa;'>" +
                    i +
                    "</span>" +
    ...
    LGraphCanvas.onShowPropertyEditor = function(item, options, e, menu, node) {
        ...
        dialog.innerHTML =
            "<span class='name' style='color: #aaa;'></span><input autofocus type='text' class='value'/><button>OK</button>";
    ...
    LGraphCanvas.prototype.prompt = function(title, value, callback, event) {
        ...
        dialog.innerHTML =
            "<span class='name' style='color: #aaa;'></span> <input autofocus type='text' class='value'/><button class='rounded'>OK</button>";
    ...
    LGraphCanvas.prototype.showSearchBox = function(event) {
        ...
        dialog.innerHTML =
            "<span class='name' style='color: #aaa;'>Search</span> <input autofocus type='text' class='value rounded'/><div class='helper'></div>";
        dialog.close = function() {
    ...
    LGraphCanvas.prototype.showEditPropertyValue = function(
        ...
        var dialog = this.createDialog(
            "<span class='name' style='color: #aaa;'>" +
                property +
                "</span>" +
                input_html +
                "<button>OK</button>",
    ...
    LGraphCanvas.onMenuNodeColors = function(value, options, e, menu, node) {
        ...
        values.push({
            value: null,
            content:
                "<span style='display: block; padding-left: 4px; color: #aaa;'>No color</span>"
        });
        ...
        for (var i in LGraphCanvas.node_colors) {
            ...
            var value = {
                value: i,
                content:
                    "<span style='display: block; color: #aaa; padding-left: 4px; border-left: 8px solid ; color: #aaa" +
                    color.color +
                    "; background-color:" +
                    color.bgcolor +
                    "'>" +
        ...
        function inner_option_clicked(v, options, e) {
            ...
            if (v.content == "Remove Slot") {
                ...
                var dialog = that.createDialog(
                    "<span class='name' style='color: #aaa;'>Name</span><input autofocus type='text'/><button>OK</button>",
                    options
                );
                var input = dialog.querySelector("input");
                if (input && slot_info) {
